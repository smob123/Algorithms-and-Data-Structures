...
public abstract class GUI {
	...
	/**
	 * Is called when the right mouse button is clicked (actually, when the mouse is
	...
	private void initialise() {
		...
		JCheckBox notForCar = new JCheckBox("not for car");
		notForCar.addItemListener(new ItemListener() {
		...
		JCheckBox notForPede = new JCheckBox("not for pedestrian");
		notForPede.addItemListener(new ItemListener() {
		...
		JCheckBox notForBicy = new JCheckBox("not for bicycle");
		notForBicy.addItemListener(new ItemListener() {
		...
		filterGroup.add(distance);
		filterGroup.add(time);
		...
		radioButtonsPanel.add(distance);
		radioButtonsPanel.add(time);
		radioButtonsPanel.add(notForCar);
		radioButtonsPanel.add(notForPede);
		radioButtonsPanel.add(notForBicy);
		filters.add(radioButtonsPanel);
