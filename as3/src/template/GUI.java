...
public abstract class GUI {
	...
	/**
	 * used to find articulation points in the graph.
	 */
	protected abstract void findAPs();

	/**
	 * finds minimum spanning tree in a graph.
	 */
	protected abstract void findMinimumSpanningTree();
	...
	private void initialise() {
		...
		JButton findAPs = new JButton("APs");
		findAPs.addActionListener(new ActionListener() {
		...
		JButton findMinSpanningTree = new JButton("Minimum Spanning Tree");
		findMinSpanningTree.addActionListener(new ActionListener() {
		...
		controls.add(search);
		controls.add(findAPs);
		controls.add(findMinSpanningTree);
